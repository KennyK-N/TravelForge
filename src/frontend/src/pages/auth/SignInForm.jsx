...
async function signIn(data) {
  const res = await axios.post(`${backEndUrl}/auth/sign-in`, data, {
...
export default function SignInForm() {
    ...
    onSuccess: async () => {
      ...
      try {
        ...
        const { theme, confirmDelete, emailNotification, providerId } =
          result.data.userSetting.data;

        const userInfo = result.data.userInfo.user;
  ...
  function googleSignIn() {
    window.location.href = `${backEndUrl}/auth/google-sign-in`;
  }
